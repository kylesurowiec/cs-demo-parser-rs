...
pub struct CMsgGcClientDisplayNotification {
    #[prost(string, optional, tag = "1")]
    pub notification_title_localization_key: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "2")]
    pub notification_body_localization_key: ::core::option::Option<::prost::alloc::string::String>,
...
impl EgcBaseMsg {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            | EgcBaseMsg::KEMsgGcReplayUploadedToYouTube => "k_EMsgGCReplay_UploadedToYouTube",
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            | "k_EMsgGCReplay_UploadedToYouTube" => Some(Self::KEMsgGcReplayUploadedToYouTube),
...
impl EgcBaseProtoObjectTypes {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            | EgcBaseProtoObjectTypes::KEProtoObjectPartyInvite => "k_EProtoObjectPartyInvite",
            | EgcBaseProtoObjectTypes::KEProtoObjectLobbyInvite => "k_EProtoObjectLobbyInvite",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub struct CMsgServerHello {
    ...
    pub client_launcher: ::core::option::Option<u32>,
    #[prost(bytes = "vec", optional, tag = "6")]
    pub legacy_steamdatagram_routing: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    #[prost(uint32, optional, tag = "7")]
...
pub struct CMsgGccStrike15V2PremierSeasonSummary {
    ...
    #[prost(message, repeated, tag = "3")]
    pub data_per_week:
        ::prost::alloc::vec::Vec<c_msg_gcc_strike15_v2_premier_season_summary::DataPerWeek>,
    #[prost(message, repeated, tag = "4")]
    pub data_per_map:
        ::prost::alloc::vec::Vec<c_msg_gcc_strike15_v2_premier_season_summary::DataPerMap>,
}
...
impl ECsgoGcMsg {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            | ECsgoGcMsg::KEMsgGccStrike15V2BetaEnrollment => "k_EMsgGCCStrike15_v2_BetaEnrollment",
...
pub struct CcsUsrMsgRoundEndReportData {
    #[prost(message, optional, tag = "1")]
    pub init_conditions:
        ::core::option::Option<ccs_usr_msg_round_end_report_data::InitialConditions>,
    #[prost(message, repeated, tag = "2")]
...
impl ECstrike15UserMessages {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            | ECstrike15UserMessages::CsUmPostRoundDamageReport => "CS_UM_PostRoundDamageReport",
...
impl EgcItemMsg {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            | EgcItemMsg::KEMsgGcVerifyCacheSubscription => "k_EMsgGCVerifyCacheSubscription",
            ...
            | EgcItemMsg::KEMsgGcAddItemToSocketDeprecated => "k_EMsgGCAddItemToSocket_DEPRECATED",
            ...
            | EgcItemMsg::KEMsgGcAddSocketToItemDeprecated => "k_EMsgGCAddSocketToItem_DEPRECATED",
            ...
            | EgcItemMsg::KEMsgGcDeliverGiftResponseGiver => "k_EMsgGCDeliverGiftResponseGiver",
            ...
            | EgcItemMsg::KEMsgGcLookupAccountNameResponse => "k_EMsgGCLookupAccountNameResponse",
            ...
            | EgcItemMsg::KEMsgGcRemoveMakersMarkResponse => "k_EMsgGCRemoveMakersMarkResponse",
            ...
            | EgcItemMsg::KEMsgGcAdjustItemEquippedState => "k_EMsgGCAdjustItemEquippedState",
            ...
            | EgcItemMsg::KEMsgGcClientDisplayNotification => "k_EMsgGCClientDisplayNotification",
            ...
            | EgcItemMsg::KEMsgGcUnlockItemStyleResponse => "k_EMsgGCUnlockItemStyleResponse",
            ...
            | EgcItemMsg::KEMsgGcTradingUpdateTradeInfo => "k_EMsgGCTrading_UpdateTradeInfo",
            | EgcItemMsg::KEMsgGcTradingSetReadiness => "k_EMsgGCTrading_SetReadiness",
            | EgcItemMsg::KEMsgGcTradingReadinessResponse => "k_EMsgGCTrading_ReadinessResponse",
            ...
            | EgcItemMsg::KEMsgGcTradingTradeTypingChatMsg => "k_EMsgGCTrading_TradeTypingChatMsg",
            ...
            | EgcItemMsg::KEMsgGcItemPreviewStatusResponse => "k_EMsgGCItemPreviewStatusResponse",
            | EgcItemMsg::KEMsgGcItemPreviewRequest => "k_EMsgGCItemPreviewRequest",
            | EgcItemMsg::KEMsgGcItemPreviewRequestResponse => "k_EMsgGCItemPreviewRequestResponse",
            ...
            | EgcItemMsg::KEMsgGcDevNewItemRequestResponse => "k_EMsgGCDev_NewItemRequestResponse",
            ...
            | EgcItemMsg::KEMsgGcStoreGetUserDataResponse => "k_EMsgGCStoreGetUserDataResponse",
            ...
            | EgcItemMsg::KEMsgGcStorePurchaseInitResponse => "k_EMsgGCStorePurchaseInitResponse",
            ...
            | EgcItemMsg::KEMsgGcToGcBannedWordListUpdated => "k_EMsgGCToGCBannedWordListUpdated",
            | EgcItemMsg::KEMsgGcToGcDirtySdoCache => "k_EMsgGCToGCDirtySDOCache",
            | EgcItemMsg::KEMsgGcToGcDirtyMultipleSdoCache => "k_EMsgGCToGCDirtyMultipleSDOCache",
            ...
            | EgcItemMsg::KEMsgGcToGcWebApiAccountChanged => "k_EMsgGCToGCWebAPIAccountChanged",
            ...
            | EgcItemMsg::KEMsgGcRequestPassportItemGrant => "k_EMsgGCRequestPassportItemGrant",
            ...
            | EgcItemMsg::KEMsgGcAdjustEquipSlotsShuffle => "k_EMsgGCAdjustEquipSlotsShuffle",
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            | "k_EMsgGCVerifyCacheSubscription" => Some(Self::KEMsgGcVerifyCacheSubscription),
            ...
            | "k_EMsgGCAddItemToSocket_DEPRECATED" => Some(Self::KEMsgGcAddItemToSocketDeprecated),
            | "k_EMsgGCAddItemToSocketResponse_DEPRECATED" => {
            ...
            | "k_EMsgGCAddSocketToItem_DEPRECATED" => Some(Self::KEMsgGcAddSocketToItemDeprecated),
            | "k_EMsgGCAddSocketToItemResponse_DEPRECATED" => {
            ...
            | "k_EMsgGCDeliverGiftResponseGiver" => Some(Self::KEMsgGcDeliverGiftResponseGiver),
            | "k_EMsgGCDeliverGiftResponseReceiver" => {
            ...
            | "k_EMsgGCLookupAccountNameResponse" => Some(Self::KEMsgGcLookupAccountNameResponse),
            ...
            | "k_EMsgGCRemoveMakersMarkResponse" => Some(Self::KEMsgGcRemoveMakersMarkResponse),
            ...
            | "k_EMsgGCAdjustItemEquippedState" => Some(Self::KEMsgGcAdjustItemEquippedState),
            ...
            | "k_EMsgGCClientDisplayNotification" => Some(Self::KEMsgGcClientDisplayNotification),
            ...
            | "k_EMsgGCUnlockItemStyleResponse" => Some(Self::KEMsgGcUnlockItemStyleResponse),
            ...
            | "k_EMsgGCTrading_UpdateTradeInfo" => Some(Self::KEMsgGcTradingUpdateTradeInfo),
            | "k_EMsgGCTrading_SetReadiness" => Some(Self::KEMsgGcTradingSetReadiness),
            | "k_EMsgGCTrading_ReadinessResponse" => Some(Self::KEMsgGcTradingReadinessResponse),
            ...
            | "k_EMsgGCTrading_TradeTypingChatMsg" => Some(Self::KEMsgGcTradingTradeTypingChatMsg),
            | "k_EMsgGCServerBrowser_FavoriteServer" => {
            ...
            | "k_EMsgGCItemPreviewStatusResponse" => Some(Self::KEMsgGcItemPreviewStatusResponse),
            | "k_EMsgGCItemPreviewRequest" => Some(Self::KEMsgGcItemPreviewRequest),
            | "k_EMsgGCItemPreviewRequestResponse" => Some(Self::KEMsgGcItemPreviewRequestResponse),
            ...
            | "k_EMsgGCDev_NewItemRequestResponse" => Some(Self::KEMsgGcDevNewItemRequestResponse),
            ...
            | "k_EMsgGCStoreGetUserDataResponse" => Some(Self::KEMsgGcStoreGetUserDataResponse),
            | "k_EMsgGCStorePurchaseInit_DEPRECATED" => {
            ...
            | "k_EMsgGCStorePurchaseInitResponse" => Some(Self::KEMsgGcStorePurchaseInitResponse),
            ...
            | "k_EMsgGCToGCBannedWordListUpdated" => Some(Self::KEMsgGcToGcBannedWordListUpdated),
            | "k_EMsgGCToGCDirtySDOCache" => Some(Self::KEMsgGcToGcDirtySdoCache),
            | "k_EMsgGCToGCDirtyMultipleSDOCache" => Some(Self::KEMsgGcToGcDirtyMultipleSdoCache),
            ...
            | "k_EMsgGCToGCWebAPIAccountChanged" => Some(Self::KEMsgGcToGcWebApiAccountChanged),
            | "k_EMsgGCRequestAnnouncements" => Some(Self::KEMsgGcRequestAnnouncements),
            | "k_EMsgGCRequestAnnouncementsResponse" => {
                Some(Self::KEMsgGcRequestAnnouncementsResponse)
            },
            | "k_EMsgGCRequestPassportItemGrant" => Some(Self::KEMsgGcRequestPassportItemGrant),
            ...
            | "k_EMsgGCAdjustEquipSlotsShuffle" => Some(Self::KEMsgGcAdjustEquipSlotsShuffle),
...
impl EUnlockStyle {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            | EUnlockStyle::KUnlockStyleFailedCantAfford => "k_UnlockStyle_Failed_CantAfford",
            | EUnlockStyle::KUnlockStyleFailedCantCommit => "k_UnlockStyle_Failed_CantCommit",
            | EUnlockStyle::KUnlockStyleFailedCantLockCache => "k_UnlockStyle_Failed_CantLockCache",
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            | "k_UnlockStyle_Failed_CantLockCache" => Some(Self::KUnlockStyleFailedCantLockCache),
            | "k_UnlockStyle_Failed_CantAffordAttrib" => {
...
impl EgcSystemMsg {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            | EgcSystemMsg::KEgcMsgGetUserGameStatsSchema => "k_EGCMsgGetUserGameStatsSchema",
            | EgcSystemMsg::KEgcMsgGetUserGameStatsSchemaResponse => {
                "k_EGCMsgGetUserGameStatsSchemaResponse"
            },
            | EgcSystemMsg::KEgcMsgGetUserStatsDeprecated => "k_EGCMsgGetUserStatsDEPRECATED",
            ...
            | EgcSystemMsg::KEgcMsgValidateSessionResponse => "k_EGCMsgValidateSessionResponse",
            | EgcSystemMsg::KEgcMsgLookupAccountFromInput => "k_EGCMsgLookupAccountFromInput",
            | EgcSystemMsg::KEgcMsgSendHttpRequest => "k_EGCMsgSendHTTPRequest",
            | EgcSystemMsg::KEgcMsgSendHttpRequestResponse => "k_EGCMsgSendHTTPRequestResponse",
            ...
            | EgcSystemMsg::KEgcMsgReceiveInterAppMessage => "k_EGCMsgReceiveInterAppMessage",
            ...
            | EgcSystemMsg::KEgcMsgAddFreeLicenseResponse => "k_EGCMsgAddFreeLicenseResponse",
            ...
            | EgcSystemMsg::KEgcMsgGetSystemStatsResponse => "k_EGCMsgGetSystemStatsResponse",
            ...
            | EgcSystemMsg::KEgcMsgGetEmailTemplateResponse => "k_EGCMsgGetEmailTemplateResponse",
            | EgcSystemMsg::KEgcMsgGrantGuestPass => "k_EGCMsgGrantGuestPass",
            | EgcSystemMsg::KEgcMsgGrantGuestPassResponse => "k_EGCMsgGrantGuestPassResponse",
            | EgcSystemMsg::KEgcMsgGetAccountDetails => "k_EGCMsgGetAccountDetails",
            | EgcSystemMsg::KEgcMsgGetAccountDetailsResponse => "k_EGCMsgGetAccountDetailsResponse",
            | EgcSystemMsg::KEgcMsgGetPersonaNames => "k_EGCMsgGetPersonaNames",
            | EgcSystemMsg::KEgcMsgGetPersonaNamesResponse => "k_EGCMsgGetPersonaNamesResponse",
            ...
            | EgcSystemMsg::KEgcMsgWebApiRegisterInterfaces => "k_EGCMsgWebAPIRegisterInterfaces",
            ...
            | EgcSystemMsg::KEgcMsgMemCachedStatsResponse => "k_EGCMsgMemCachedStatsResponse",
            ...
            | EgcSystemMsg::KEgcMsgMasterSetWebApiRouting => "k_EGCMsgMasterSetWebAPIRouting",
            | EgcSystemMsg::KEgcMsgMasterSetWebApiRoutingResponse => {
                "k_EGCMsgMasterSetWebAPIRoutingResponse"
            },
            | EgcSystemMsg::KEgcMsgMasterSetClientMsgRouting => "k_EGCMsgMasterSetClientMsgRouting",
            ...
            | EgcSystemMsg::KEgcMsgGetPurchaseTrustStatus => "k_EGCMsgGetPurchaseTrustStatus",
            ...
            | EgcSystemMsg::KEgcMsgGcAccountVacStatusChange => "k_EGCMsgGCAccountVacStatusChange",
            | EgcSystemMsg::KEgcMsgCheckFriendship => "k_EGCMsgCheckFriendship",
            | EgcSystemMsg::KEgcMsgCheckFriendshipResponse => "k_EGCMsgCheckFriendshipResponse",
            ...
            | EgcSystemMsg::KEgcMsgAccountPhoneNumberChange => "k_EGCMsgAccountPhoneNumberChange",
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            | "k_EGCMsgValidateSessionResponse" => Some(Self::KEgcMsgValidateSessionResponse),
            ...
            | "k_EGCMsgSendHTTPRequestResponse" => Some(Self::KEgcMsgSendHttpRequestResponse),
            ...
            | "k_EGCMsgGetEmailTemplateResponse" => Some(Self::KEgcMsgGetEmailTemplateResponse),
            ...
            | "k_EGCMsgGetAccountDetailsResponse" => Some(Self::KEgcMsgGetAccountDetailsResponse),
            | "k_EGCMsgGetPersonaNames" => Some(Self::KEgcMsgGetPersonaNames),
            | "k_EGCMsgGetPersonaNamesResponse" => Some(Self::KEgcMsgGetPersonaNamesResponse),
            | "k_EGCMsgMultiplexMsg" => Some(Self::KEgcMsgMultiplexMsg),
            | "k_EGCMsgMultiplexMsgResponse" => Some(Self::KEgcMsgMultiplexMsgResponse),
            | "k_EGCMsgWebAPIRegisterInterfaces" => Some(Self::KEgcMsgWebApiRegisterInterfaces),
            ...
            | "k_EGCMsgMasterSetDirectoryResponse" => Some(Self::KEgcMsgMasterSetDirectoryResponse),
            | "k_EGCMsgMasterSetWebAPIRouting" => Some(Self::KEgcMsgMasterSetWebApiRouting),
            | "k_EGCMsgMasterSetWebAPIRoutingResponse" => {
                Some(Self::KEgcMsgMasterSetWebApiRoutingResponse)
            },
            | "k_EGCMsgMasterSetClientMsgRouting" => Some(Self::KEgcMsgMasterSetClientMsgRouting),
            | "k_EGCMsgMasterSetClientMsgRoutingResponse" => {
            ...
            | "k_EGCMsgGCAccountVacStatusChange" => Some(Self::KEgcMsgGcAccountVacStatusChange),
            | "k_EGCMsgCheckFriendship" => Some(Self::KEgcMsgCheckFriendship),
            | "k_EGCMsgCheckFriendshipResponse" => Some(Self::KEgcMsgCheckFriendshipResponse),
            ...
            | "k_EGCMsgDPPartnerMicroTxnsResponse" => Some(Self::KEgcMsgDpPartnerMicroTxnsResponse),
            | "k_EGCMsgVacVerificationChange" => Some(Self::KEgcMsgVacVerificationChange),
            | "k_EGCMsgAccountPhoneNumberChange" => Some(Self::KEgcMsgAccountPhoneNumberChange),
...
impl EsoMsg {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            | EsoMsg::KEsoMsgCacheSubscriptionRefresh => "k_ESOMsg_CacheSubscriptionRefresh",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            | "k_ESOMsg_CacheSubscriptionCheck" => Some(Self::KEsoMsgCacheSubscriptionCheck),
            | "k_ESOMsg_CacheSubscriptionRefresh" => Some(Self::KEsoMsgCacheSubscriptionRefresh),
            | _ => None,
        }
    }
}
...
impl EgcBaseClientMsg {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            | EgcBaseClientMsg::KEMsgGcClientConnectionStatus => "k_EMsgGCClientConnectionStatus",
            | EgcBaseClientMsg::KEMsgGcServerConnectionStatus => "k_EMsgGCServerConnectionStatus",
...
impl EgcToGcMsg {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            | EgcToGcMsg::KEgcToGcMsgMasterStartupComplete => "k_EGCToGCMsgMasterStartupComplete",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            | "k_EGCToGCMsgMasterStartupComplete" => Some(Self::KEgcToGcMsgMasterStartupComplete),
            | _ => None,
        }
    }
}
...
impl ECommunityItemClass {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            | ECommunityItemClass::KECommunityItemClassInvalid => "k_ECommunityItemClass_Invalid",
            | ECommunityItemClass::KECommunityItemClassBadge => "k_ECommunityItemClass_Badge",
            | ECommunityItemClass::KECommunityItemClassGameCard => "k_ECommunityItemClass_GameCard",
            | ECommunityItemClass::KECommunityItemClassProfileBackground => {
                "k_ECommunityItemClass_ProfileBackground"
            },
            | ECommunityItemClass::KECommunityItemClassEmoticon => "k_ECommunityItemClass_Emoticon",
            ...
            | ECommunityItemClass::KECommunityItemClassGameGoo => "k_ECommunityItemClass_GameGoo",
            | ECommunityItemClass::KECommunityItemClassProfileModifier => {
                "k_ECommunityItemClass_ProfileModifier"
            },
            | ECommunityItemClass::KECommunityItemClassScene => "k_ECommunityItemClass_Scene",
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            | "k_ECommunityItemClass_BoosterPack" => Some(Self::KECommunityItemClassBoosterPack),
            | "k_ECommunityItemClass_Consumable" => Some(Self::KECommunityItemClassConsumable),
            ...
            | "k_ECommunityItemClass_SalienItem" => Some(Self::KECommunityItemClassSalienItem),
            | _ => None,
        }
    }
}
...
impl ECommunityItemAttribute {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            | "k_ECommunityItemAttribute_Invalid" => Some(Self::KECommunityItemAttributeInvalid),
            | "k_ECommunityItemAttribute_CardBorder" => {
                Some(Self::KECommunityItemAttributeCardBorder)
            },
            | "k_ECommunityItemAttribute_Level" => Some(Self::KECommunityItemAttributeLevel),
            | "k_ECommunityItemAttribute_IssueNumber" => {
...
pub struct CMsgSteamDatagramCertificate {
    ...
    #[prost(message, optional, tag = "11")]
    pub legacy_identity_binary: ::core::option::Option<CMsgSteamNetworkingIdentityLegacyBinary>,
    #[prost(string, optional, tag = "12")]
...
pub struct CMsgSteamDatagramRelayAuthTicket {
    ...
    pub time_expiry: ::core::option::Option<u32>,
    #[prost(string, optional, tag = "14")]
    pub authorized_client_identity_string: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "15")]
    pub gameserver_identity_string: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(fixed32, optional, tag = "3")]
    pub authorized_public_ip: ::core::option::Option<u32>,
    ...
    #[prost(message, repeated, tag = "8")]
    pub extra_fields: ::prost::alloc::vec::Vec<c_msg_steam_datagram_relay_auth_ticket::ExtraField>,
    #[prost(fixed64, optional, tag = "2")]
    ...
    pub legacy_authorized_client_identity_binary:
        ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    #[prost(bytes = "vec", optional, tag = "13")]
    pub legacy_gameserver_identity_binary: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
}
...
pub struct CMsgSteamNetworkingP2pRendezvous {
    ...
    #[prost(message, optional, tag = "4")]
    pub connect_request:
        ::core::option::Option<c_msg_steam_networking_p2p_rendezvous::ConnectRequest>,
    #[prost(message, optional, tag = "5")]
    pub connect_ok: ::core::option::Option<c_msg_steam_networking_p2p_rendezvous::ConnectOk>,
    #[prost(message, optional, tag = "6")]
    pub connection_closed:
        ::core::option::Option<c_msg_steam_networking_p2p_rendezvous::ConnectionClosed>,
    #[prost(uint32, optional, tag = "11")]
    pub ack_reliable_msg: ::core::option::Option<u32>,
    #[prost(uint32, optional, tag = "12")]
    pub first_reliable_msg: ::core::option::Option<u32>,
    #[prost(message, repeated, tag = "13")]
    pub reliable_messages:
        ::prost::alloc::vec::Vec<c_msg_steam_networking_p2p_rendezvous::ReliableMessage>,
    #[prost(message, repeated, tag = "15")]
    pub application_messages:
        ::prost::alloc::vec::Vec<c_msg_steam_networking_p2p_rendezvous::ApplicationMessage>,
}
...
pub mod c_msg_steam_networking_p2p_rendezvous {
    ...
    pub struct ConnectRequest {
        #[prost(message, optional, tag = "6")]
        pub crypt: ::core::option::Option<super::CMsgSteamDatagramSessionCryptInfoSigned>,
        #[prost(message, optional, tag = "7")]
...
pub struct CMsgSteamDatagramRouterPingReply {
    ...
    pub flags: ::core::option::Option<u32>,
    #[prost(message, repeated, tag = "10")]
    pub route_exceptions:
        ::prost::alloc::vec::Vec<c_msg_steam_datagram_router_ping_reply::RouteException>,
    #[prost(message, repeated, tag = "13")]
    pub alt_addresses: ::prost::alloc::vec::Vec<c_msg_steam_datagram_router_ping_reply::AltAddress>,
...
pub struct CMsgSteamDatagramClientPingSampleReply {
    ...
    #[prost(message, repeated, tag = "2")]
    pub pops: ::prost::alloc::vec::Vec<c_msg_steam_datagram_client_ping_sample_reply::Pop>,
    #[prost(message, repeated, tag = "3")]
    pub legacy_data_centers:
        ::prost::alloc::vec::Vec<c_msg_steam_datagram_client_ping_sample_reply::LegacyDataCenter>,
}
...
pub struct CMsgSteamDatagramClientSwitchedPrimary {
    ...
    #[prost(message, optional, tag = "9")]
    pub from_quality_now:
        ::core::option::Option<c_msg_steam_datagram_client_switched_primary::RouterQuality>,
    #[prost(message, optional, tag = "10")]
    pub to_quality_now:
        ::core::option::Option<c_msg_steam_datagram_client_switched_primary::RouterQuality>,
    #[prost(message, optional, tag = "11")]
    pub from_quality_then:
        ::core::option::Option<c_msg_steam_datagram_client_switched_primary::RouterQuality>,
    #[prost(message, optional, tag = "12")]
    pub to_quality_then:
        ::core::option::Option<c_msg_steam_datagram_client_switched_primary::RouterQuality>,
...
pub struct CMsgSteamDatagramConnectionClosed {
    ...
    #[prost(message, optional, tag = "13")]
    pub legacy_from_identity_binary:
        ::core::option::Option<CMsgSteamNetworkingIdentityLegacyBinary>,
    #[prost(fixed64, optional, tag = "3")]
    ...
    pub from_relay_session_id: ::core::option::Option<u32>,
    #[prost(bytes = "vec", optional, tag = "11")]
    pub forward_target_relay_routing_token: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    #[prost(uint32, optional, tag = "12")]
...
pub struct CMsgSteamDatagramGameserverSessionEstablished {
    ...
    #[prost(bytes = "vec", optional, tag = "7")]
    pub dummy_legacy_identity_binary: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    #[prost(fixed64, optional, tag = "3")]
...
pub struct CMsgSteamDatagramP2pSessionRequestBody {
    ...
    #[prost(bytes = "vec", optional, tag = "16")]
    pub encryption_my_ephemeral_public_key: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    #[prost(uint32, optional, tag = "8")]
    pub protocol_version: ::core::option::Option<u32>,
    #[prost(uint64, optional, tag = "9")]
    pub network_config_version: ::core::option::Option<u64>,
...
pub struct CMsgSteamDatagramP2pRoutes {
    #[prost(message, repeated, tag = "1")]
    pub relay_clusters: ::prost::alloc::vec::Vec<c_msg_steam_datagram_p2p_routes::RelayCluster>,
    #[prost(message, repeated, tag = "2")]
...
pub mod c_msg_steam_datagram_p2p_routes {
    ...
    pub struct RelayCluster {
        ...
        #[prost(bytes = "vec", optional, tag = "4")]
        pub session_relay_routing_token: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    }
    #[allow(clippy::derive_partial_eq_without_eq)]
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Route {
...
impl ESteamDatagramMsgId {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            | ESteamDatagramMsgId::KESteamDatagramMsgInvalid => "k_ESteamDatagramMsg_Invalid",
            ...
            | ESteamDatagramMsgId::KESteamDatagramMsgNoSession => "k_ESteamDatagramMsg_NoSession",
            | ESteamDatagramMsgId::KESteamDatagramMsgDiagnostic => "k_ESteamDatagramMsg_Diagnostic",
            ...
            | ESteamDatagramMsgId::KESteamDatagramMsgConnectOk => "k_ESteamDatagramMsg_ConnectOK",
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            | "k_ESteamDatagramMsg_RelayHealth" => Some(Self::KESteamDatagramMsgRelayHealth),
            | "k_ESteamDatagramMsg_ConnectRequest" => Some(Self::KESteamDatagramMsgConnectRequest),
            | "k_ESteamDatagramMsg_ConnectOK" => Some(Self::KESteamDatagramMsgConnectOk),
            | "k_ESteamDatagramMsg_ConnectionClosed" => {
                Some(Self::KESteamDatagramMsgConnectionClosed)
            },
            | "k_ESteamDatagramMsg_NoConnection" => Some(Self::KESteamDatagramMsgNoConnection),
            | "k_ESteamDatagramMsg_TicketDecryptRequest" => {
            ...
            | "k_ESteamDatagramMsg_P2PStatsClient" => Some(Self::KESteamDatagramMsgP2pStatsClient),
            | "k_ESteamDatagramMsg_P2PStatsRelay" => Some(Self::KESteamDatagramMsgP2pStatsRelay),
            | "k_ESteamDatagramMsg_P2PBadRoute" => Some(Self::KESteamDatagramMsgP2pBadRoute),
            | "k_ESteamDatagramMsg_GameserverPingReply" => {
...
impl ESteamNetworkingUdpMsgId {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            | "k_ESteamNetworkingUDPMsg_ConnectOK" => Some(Self::KESteamNetworkingUdpMsgConnectOk),
            | "k_ESteamNetworkingUDPMsg_ConnectionClosed" => {
...
pub struct CuiFontFilePackagePb {
    ...
    #[prost(message, repeated, tag = "2")]
    pub encrypted_font_files:
        ::prost::alloc::vec::Vec<cui_font_file_package_pb::CuiEncryptedFontFilePb>,
}
